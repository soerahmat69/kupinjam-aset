...
export const Main = ({ children }) => {
  ...
  return (
    <React.Fragment>
      {TambahData && <MAsset setcloseStatus={handleTambahData} />}
      <main className="font-[poppins] black  text-[#252B48] w-full h-max ">
        ...
        <div className="   w-full   ">
          ...
          <div className=" w-full h-[700px]  flex flex-col gap-[22px]">
            ...
            <div className=" h-[670px]  overflow-y-auto overflow-x-hidden  py-[4px] ">
           <div className=" mx-3 grid grid-cols-6 gap-[30px]  ">
            {children}
            </div>
            </div>
          </div>
