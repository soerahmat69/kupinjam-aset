...
export const MAsset = ({ setcloseStatus }) => {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("nama_kendaraan", form.nama_kendaraan);
    formData.append("plat_nomor", form.plat_nomor);
    formData.append("km", form.km);
    formData.append("bbm", form.bbm);
    formData.append("assethPath", form.assetPath);

    axios
      .post(`http://localhost:8080/admin/asset/add`, formData)
      .then((res) => {
