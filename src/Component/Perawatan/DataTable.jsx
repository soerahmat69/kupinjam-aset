...
export const DataTable = ({ data }) => {
  ...
  const HandleLihatClick = () => setLihatClick(!LihatClick);
  return (
    <>
      {LihatClick && (
        <MInfo
          setcloseStatus={HandleLihatClick}
          tittle={"Keperluan"}
          info={"Ke Jl erkasari konoha gakure"}
        />
      )}
      <table class="w-full font-[poppins] ">
        <thead className="border-[#252B48]  border-b-2   sticky top-0 uppercase  text-[#00000080]">
          <tr className="text-[14px] ">
            ...
            <th className="text-start pb-[26px] ">Terakhir Perawatan</th>
            <th className="text-start  pb-[26px]  ">total perawatan</th>
            <th className="text-start  pb-[26px]  ">Progress perawatan</th>
          ...
          <tr className="  ">
            <td className="flex py-[17px] items-center gap-[5px] ">
              ...
              <div className="flex flex-col">
                <span>B1234CXT ,</span>
                <span>Bus Hitler</span>
              </div>
            </td>
            <td className="py-[17px]">01/01/2001 </td>
            <td className="py-[17px]">4</td>
            <td className="py-[17px]">40%</td>
            <td className="py-[17px] ">
              <svg
                onClick={HandlemoreTable}
              ...
              <div className="relative">
                ...
                >
                  <ul className="divide-y divide-[#252B4880]">
                    <li
                      href="#"
                      className="  flex items-center   gap-[5px] px-4 py-[6px]   text-[13px] text-gray-700 hover:bg-gray-100"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="15"
                    ...
                    <li
                      href="#"
                      className="  flex   gap-[5px] px-4 py-[6px] items-center  text-[13px] text-gray-700 hover:bg-gray-100"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="13"
