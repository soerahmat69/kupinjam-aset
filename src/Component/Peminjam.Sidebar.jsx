  ...
  return (
    <nav className="flex-none px-[22px] py-[22px] w-[273px] flex flex-col justify-between h-full    bg-[#252b48] font-[poppins] rounded-[16px] ">
      <ul className="">
        ...
        <li onClick={()=>handleClickSidebar("/dashboard")} className="cursor-pointer flex gap-3 items-center   h-[38px] ">
          <svg
        ...
        <li onClick={()=>handleClickSidebar("/permintaan")} className="cursor-pointer flex gap-3 items-center  h-[38px] ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="21"
            height="21"
      ...
      <div onClick={handleProfilClick} className="w-max h-max  flex items-center gap-3 cursor-pointer ">
